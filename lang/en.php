...
$lang = array(
    ...
    "successfulRegistration" => "You have successfully completed the registration. To validate your email address, click the link in the email.",
    "notUniqueEmail" => "User with that email already exists.",

    // Login page
    "loginLabel" => "Login",
    "usernameLabel" => "Username",
    "invalidLogin" => "Incorrect email and password combination.",
